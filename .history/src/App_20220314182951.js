      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col w-96" >
          ...
          <div><input
           ...
           <div className="flex">
             <div className="w-2/4"><label>Min</label><br></br><input className="w-20 bg-gray-100 border border-gray-400 rounded-lg" type="text" value="0"/></div>
             <div  className="w-2/4"><label>Max</label><br></br><input className="w-20 bg-gray-100 border border-gray-400 rounded-lg" type="text" value="000"/></div>
           </div>
          </div>
