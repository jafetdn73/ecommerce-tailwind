      ...
      <div className="bg-gray-100">
        <div className="bg-gray-100">
          ...
          <div className="bg-gray-100 flex flex-col">
           ...
           <div >
             <input type="checkbox" className="mr-10"></input><label>Termurah</label>
          </div>
          <div>
            <input type="checkbox"></input><label>Terlaris</label>
          </div>
          <div>
            <input type="checkbox"></input><label>Termahal</label>
          </div>
