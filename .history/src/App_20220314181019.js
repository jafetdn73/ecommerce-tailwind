      ...
      <div className="flex justify-between mt-16">
        ...
        <div className="flex gap-10">
          ...
          <div className="relative">
            <img src="/images/cart-icon.png" alt="icon" className="w-10 h-8"/>
            <label className="w-1 h-1 absolute bottom-2 -left-2 bg-orange-600 text-white py-0.25 px-1 rounded-full text-sm">4</label>
          </div>
        </div>
      </div>
