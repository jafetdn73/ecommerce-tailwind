      ...
      <div className="bg-gray-100">
        <div className="bg-gray-100">
          ...
          <div className="bg-gray-100 flex flex-col">
            <h1 className="font-bold">Order By</h1>
           <div >
             <input type="checkbox" className="mr-2"></input><label>Termurah</label>
          </div>
          <div>
            <input type="checkbox"  className="mr-2"></input><label>Terlaris</label>
          </div>
          <div>
            <input type="checkbox"  className="mr-2"></input><label>Termahal</label>
          </div>
