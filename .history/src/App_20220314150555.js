      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col bg-lime-100 w-full" >
          <div className="w-60 m-8 p-4 bg-white border border-gray-400 rounded-lg">
            <div className="relative">
              <img src="images/bola-susun.png" alt="bolu-susun" width="236" height="180"/>
              <label className="ml-2 absolute bottom-16 left-0 mb-2 bg-gray-200 pl-2 pr-2 rounded-xl">- 36 %</label>
            </div>
            <div>
