    ...
    <div className="bg-white container mx-auto">
      ...
      <div className="bg-gray-100 mt-10 py-4 pl-4 text-base font-medium">
        <ul className="flex gap-12">
          <div className="flex"><li>Bakery</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
          <div className="flex"><li>Fruit and vegetables</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
          <div className="flex"><li>Meat and fish</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
          <div className="flex"><li>Drinks</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
          <div className="flex"><li>Kitchen</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
          <div className="flex"><li>Special Nutrition</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
          <div className="flex"><li>Pharmacy</li><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-icon.png" alt="user"/></div>
        </ul>
        </div>
      ...
      <div className="flex gap-4">
        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
          <div className="flex relative">
            <img src="images/bolu-susun.png" alt="bolu-susun" width="236" height="180"/>
          ...
          <div>
          <h1 className="font-bold text-base mt-4 mb-2">Bolu Susun</h1>
          <p className="text-sm">Disusun dengan penuh kenangan</p>
          </div>
          <div className="flex justify-between mt-4">
            <div className="flex flex-col">
              <label className="font-bold text-xl">36.000</label>
              <label className="line-through text-xs -mt-1">40.000</label>
            </div>
            <div>
        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
          <div className="flex relative">
            <img src="images/mie-aceh.png" alt="mie-aceh" width="236" height="180"/>
            <label className="text-lime-800 font-bold text-xs ml-2 absolute bottom-26 left-0 bg-white mt-2 mb-2 pl-1 pr-1 rounded-xl">- 36 %</label>
          </div>
          <div>
          <h1 className="font-bold text-base mt-4 mb-2">Mie Aceh</h1>
          <p className="text-sm">Rasanya menusuk jiwa dan raga</p>
          </div>
          <div className="flex justify-between mt-4">
            <div className="flex flex-col">
              <label className="font-bold text-xl">26.000</label>
              <label className="line-through text-xs -mt-1">30.000</label>
            </div>
            <div>
              <button className="py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Buy Now</button>
            </div>
        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
          <div className="flex relative">
            <img src="images/bolu-lapis.png" alt="bolu-lapis" width="236" height="180"/>
            <label className="text-lime-800 font-bold text-xs ml-2 absolute bottom-26 left-0 bg-white mt-2 mb-2 pl-1 pr-1 rounded-xl">- 36 %</label>
          </div>
          <div>
          <h1 className="font-bold text-base mt-4 mb-2">Bolu Lapis</h1>
          <p className="text-sm">Lapisan legit di setiap sentuhan</p>
          </div>
          <div className="flex justify-between mt-4">
            <div className="flex flex-col">
              <label className="font-bold text-xl">24.000</label>
              <label className="line-through text-xs -mt-1"></label>
            </div>
            <div>
              <button className="py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Buy Now</button>
            </div>
        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
          <div className="flex relative">
            <img src="images/donat.png" alt="donat" width="236" height="180"/>
            <label className="text-lime-800 font-bold text-xs ml-2 absolute bottom-26 left-0 bg-white mt-2 mb-2 pl-1 pr-1 rounded-xl">- 36 %</label>
          </div>
          <div>
          <h1 className="font-bold text-base mt-4 mb-2">Donat</h1>
          <p className="text-sm">Rasa Donat</p>
          </div>
          <div className="flex justify-between mt-4">
            <div className="flex flex-col">
              <label className="font-bold text-xl">15.000</label>
              <label className="line-through text-xs -mt-1"></label>
            </div>
            <div>
              <button className="py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Buy Now</button>
        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
          <div className="flex relative">
            <img src="images/pizza.png" alt="pizza" width="236" height="180"/>
            <label className="text-lime-800 font-bold text-xs ml-2 absolute bottom-26 left-0 bg-white mt-2 mb-2 pl-1 pr-1 rounded-xl">- 36 %</label>
          </div>
          <div>
          <h1 className="font-bold text-base mt-4 mb-2">Pizza</h1>
          <p className="text-sm">Potongan penuh nikmat</p>
          </div>
          <div className="flex justify-between mt-4">
            <div className="flex flex-col">
              <label className="font-bold text-xl">30.000</label>
              <label className="line-through text-xs -mt-1">36.000</label>
            </div>
            <div>
              <button className="py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Buy Now</button>
            </div>
        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
          <div className="flex relative">
            <img src="images/mata-sapi.png" alt="mata-sapi" width="236" height="180"/>
            <label className="text-lime-800 font-bold text-xs ml-2 absolute bottom-26 left-0 bg-white mt-2 mb-2 pl-1 pr-1 rounded-xl">- 36 %</label>
          </div>
          <div>
          <h1 className="font-bold text-base mt-4 mb-2">Mata Sapi</h1>
          <p className="text-sm">Penuh mata mata</p>
          </div>
          <div className="flex justify-between mt-4">
            <div className="flex flex-col">
              <label className="font-bold text-xl">12.000</label>
              <label className="line-through text-xs -mt-1"></label>
            </div>
            <div>
              <button className="py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Buy Now</button>
        ...
        <div className="flex justify-center"><button className="mt-16 py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Show More Products<span><img className="ml-1 mt-2 w-3 h-2" src="/images/dropdown-white-icon.png" alt="user"/></span></button></div>  
      </div>
