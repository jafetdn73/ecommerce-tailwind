  ...
  return (
    <div className="bg-white container mx-auto">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex justify-center"><button className="mt-16 py-1 px-3 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Show More Products</button></div>  
      </div>
