  ...
  return (
    <div className="bg-white container mx-auto">
      ...
      <div className="bg-gray-100">
        {/* Side Bar Container */}
        <div className="flex flex-col w-60 bg-red-100" >
          ...
          <div><input
           ...
           <div className="flex">
             <div className="w-2/4"><label>Min</label><br></br><input className="w-20 bg-gray-100 border border-gray-300 rounded-lg" type="text"/></div>
             <div  className="w-2/4"><label>Max</label><br></br><input className="w-20 bg-gray-100 border border-gray-300 rounded-lg" type="text"/></div>
           </div>
          </div>
          <div className="flex"><button className="py-1 px-3 mr-8 rounded-lg font-bold bg-lime-700 text-white">Apply</button><label>Reset</label></div>
        </div>
        <div className="bg-gray-100">
