      ...
      <div className="bg-gray-100">
        ...
        <div className="flex flex-col w-60 bg-red-100" >
          ...
          <div><input
           ...
           <div className="flex">
             <div className="w-2/4 border-gray-50"><label>Min</label><br></br><input className="w-20" type="text"/></div>
             <div  className="w-2/4 border-gray-50"><label>Max</label><br></br><input className="w-20" type="text"/></div>
           </div>
          </div>
