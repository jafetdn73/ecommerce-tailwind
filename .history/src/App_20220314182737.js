      ...
      <div className="flex justify-between mt-16">
        ...
        <div className="flex gap-10">
          ...
          <div className="relative">
            <img src="/images/cart-icon.png" alt="icon" className="w-12 h-6"/>
            <label className="w-3 h-4 font-bold absolute bottom-2 -left-2 bg-orange-600 text-white pl-1 pt-0 rounded-full text-xs">4</label>
          </div>
        </div>
      </div>
