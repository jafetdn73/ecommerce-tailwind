        ...
        <div className="flex flex-col bg-lime-100 w-full" >
          <div className="w-60 m-8 p-4 bg-white border border-gray-400 rounded-lg">
            ...
            <div className="flex justify-between mt-4">
              <div className="font-bold text-xl">36.000<br></br>
              <span className="line-through text-xs">40.000</span></div>
              <div>
                <button className="py-1 px-3 mr-8 rounded-lg font-bold bg-lime-700 text-white">Buy Now</button>
              </div>
            </div>
          </div>
