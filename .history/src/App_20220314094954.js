      ...
      <div className="bg-gray-100">
        ...
        <div className="flex flex-col w-60 bg-red-100" >
          ...
          <div><input
           ...
           <div className="flex">
             <div className="w-2/4"><label>Min</label><br></br><input className="w-20 border-gray-100" type="text"/></div>
             <div  className="w-2/4"><label>Max</label><br></br><input className="w-20 border-gray-100" type="text"/></div>
           </div>
          </div>
