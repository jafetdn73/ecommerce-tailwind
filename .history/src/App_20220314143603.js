      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col bg-lime-100 w-full" >
          <div className="w-60 m-8 p-4 bg-white border border-gray-400 rounded-lg">
            <div><label className="mb-2 bg-gray-200 pl-2 pr-2 rounded-xl">32</label></div>
            <div className="-mt-20"><img src="images/bola-susun.png" alt="bolu-susun" width="236" height="180"/></div>
            <div>
