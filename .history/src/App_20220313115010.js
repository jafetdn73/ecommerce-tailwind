      ...
      <div className="bg-gray-100">
        <div className="bg-gray-100">
          ...
          <div className="bg-gray-100 flex flex-col">
           ...
           <div >
             <input type="checkbox" className="text-green-500 w-5 h-5 mr-2 mb-2"></input><label>Termurah</label>
          </div>
          <div>
            <input type="checkbox"  className="mr-2 mb-2"></input><label>Terlaris</label>
          </div>
          <div>
            <input type="checkbox"  className="mr-2 mb-2"></input><label>Termahal</label>
          </div>
