    ...
    <div className="bg-white container mx-auto">
      ...
      <div className="bg-gray-100">
        ...
        <div className="flex flex-col w-60 bg-yellow-100" >
          ...
          {/* Order By Categories */}
          <div className="form-check bg-gray-100 flex flex-col">
            <h1 className="font-bold mb-2">Order By</h1>

            <div class="flex justify-center">
  <div>
    <div class="">
      <input class=" appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-lime-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" value="" id="flexCheckDefault"></input>
      <label class="form-check-label inline-block text-gray-800" for="flexCheckDefault">
        Default checkbox
           ...
           <div>
             <input type="checkbox" className="form-check-input checked:bg-lime-600 w-5 h-5 mr-2 mb-2">
               </input>
