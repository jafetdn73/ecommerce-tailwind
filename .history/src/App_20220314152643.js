        ...
        <div className="flex flex-col bg-lime-100 w-full" >
          <div className="w-60 m-8 p-4 bg-white border border-gray-400 rounded-lg">
            <div className="flex relative">
              ...
              <label className="font-bold text-xs ml-2 absolute bottom-26 left-0 bg-white mt-2 mb-2 pl-1 pr-1 rounded-xl">- 36 %</label>
            </div>
            <div>
            ...
            <div className="flex justify-between mt-4">
              ...
              <div>
                <button className="py-1 px-3 rounded-lg font-bold border border-lime-800 bg-lime-700 text-white">Buy Now</button>
              </div>
            </div>
          </div>
