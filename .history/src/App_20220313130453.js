  ...
  return (
    <div className="bg-white container mx-auto">
      ...
      <div className="bg-gray-100">
        <div className="flex flex-col w-48 bg-yellow-100" >
          <div className="flex flex-col">
            <h1 className="font-bold text-base mb-4">Categories</h1>
            <ul>
              <div className="flex justify-between">
                <li>Bolu</li><label className="bg-gray-200 pl-2 pr-2 rounded-xl">320</label>
              </div>
              <div className="flex justify-between">
                <li>Mie</li><label className="bg-gray-200 pl-2 pr-2 rounded-xl">112</label>
              </div>
              <div className="flex justify-between">
                <li>Pizza</li><label className="bg-gray-200 pl-2 pr-2 rounded-xl">32</label>
              </div>
              <div className="flex justify-between">
                <li>Dessert</li><label className="bg-gray-200 pl-2 pr-2 rounded-xl">48</label>
              </div>
            </ul>
          </div>
          <div className="bg-gray-100 flex flex-col">
           ...
           <div >
             <input type="checkbox" className="checked:bg-lime-600 w-5 h-5 mr-2 mb-2">
               </input
               ><label className="orm-check-label">Termurah</label>
          </div>
          <div>
            <input type="checkbox"  className="bg-lime-600 w-5 h-5 mr-2 mb-2"></input><label>Terlaris</label>
          </div>
          <div>
            <input type="checkbox"  className="bg-lime-600 w-5 h-5 mr-2 mb-2"></input><label>Termahal</label>
          </div>
