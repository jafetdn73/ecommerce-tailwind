    ...
    <div className="bg-white container mx-auto">
      ...
      <div className="bg-gray-100">
        ...
        <div className="flex flex-col w-60 bg-yellow-100" >
          ...
          <div>
            <input type="checkbox"  className="accent-lime-600 w-5 h-5 mr-2 mb-2"></input>
            <span>Terlaris</span>
          </div>
          <div>
            <input type="checkbox"  className="accent-lime-600 w-5 h-5 mr-2 mb-2"></input><label>Termahal</label>
          </div>
          </div>
          {/* Rating Container */}
          <div className="bg-gray-100">
