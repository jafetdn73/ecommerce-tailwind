      ...
      <div className="bg-gray-100">
        ...
        <div className="flex flex-col w-60 bg-yellow-100" >
          ...
          <div className="bg-gray-100 flex flex-col">
           ...
           <div>
             <input type="checkbox" className="bg-white checked:bg-lime-600 w-5 h-5 mr-2 mb-2">
               </input>
               <label >Termurah</label>
          </div>
          <div>
            <input type="checkbox"  className="form-check-input  appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"></input>
