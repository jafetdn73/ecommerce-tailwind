...
function ProductCard(props){
    ...
    return(
        <div className="w-72 h-fit p-4 bg-white border border-gray-400 rounded-lg">
                  ...
                  <div className="w-36 flex justify-between mt-4">
                   <div className="flex flex-col">
                    <label><NumberFormat class="font-bold text-xl" thousandSeparator={"."} decimalSeparator={","} prefix={'Rp '} value={discountPrice} /></label>
