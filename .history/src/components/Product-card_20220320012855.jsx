        ...
        <div className="w-70 h-fit p-4 bg-white border border-gray-400 rounded-lg">
                  ...
                  <div className="flex flex-col">
                    ...
                    {item.discountPercent>0 && (
                      <label className="line-through text-xs -mt-1"><NumberFormat class="font-bold text-xl" thousandSeparator={"."} decimalSeparator={","} prefix={'Rp '} value={item.originalPrice} /></label>
                    )}
                  </div>
                <div>
