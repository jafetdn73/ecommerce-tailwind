  ...
  return (
    <div className="bg-white container mx-auto">
      ...
      {/* Show More Products */}
        ...
        <div className="flex justify-center relative"><button className="flex mt-16 py-1 px-6 rounded-lg font-bold border-2 border-lime-800 bg-lime-700 text-white">Show More Products<span><DownOutlined className="text-xs ml-1 absolute bottom-1"/></span></button></div>  
       </div>
